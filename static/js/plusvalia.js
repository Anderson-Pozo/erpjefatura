$(function () {
    ...
    function sumap() {
        ...
        let val_fecha_escritura = moment(i_fecha_escritura.val());
        let val_fecha_tramite = moment(i_fecha_tramite.val());
        // console.log(val_fecha_escritura);
        // console.log(val_fecha_tramite);

        let anios = val_fecha_tramite.diff(val_fecha_escritura, "years")
        // $("#res").text(anios)
    ...
    i_precio_venta.on('change', () => sumap());

    i_precio_adquisicion.on('change', () => sumap());

    i_fecha_escritura.on('change', () => sumap());

    i_fecha_tramite.on('change', () => sumap());
